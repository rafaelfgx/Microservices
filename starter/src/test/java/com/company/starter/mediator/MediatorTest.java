...
class MediatorTest {
    ...
    void shouldExecuteHandlerWhenRequestIsDispatched() {
        mediator.handleRequest(RequestHandlerImpl.class, new Request("message"));
    }

    @Test
    void shouldThrowWhenRequestIsInvalid() {
        Assertions.assertThrows(ConstraintViolationException.class, () -> mediator.handleRequest(RequestHandlerImpl.class, new Request(" ")));
        Assertions.assertThrows(ConstraintViolationException.class, () -> mediator.handle(RequestResponseHandlerImpl.class, new Request(" ")));
    }
    ...
    void shouldReturnResponseWhenRequestResponseHandlerIsDispatched() {
        final var response = mediator.handle(RequestResponseHandlerImpl.class, new Request("message"));
    ...
    void shouldReturnResponseEntityWhenRequestResponseEntityHandlerIsDispatched() {
        final var response = mediator.handle(RequestResponseEntityHandlerImpl.class, new Request("message"));
    ...
    void shouldReturnResponseEntityListWhenRequestResponseEntityListHandlerIsDispatched() {
        final var response = mediator.handle(RequestResponseEntityListHandlerImpl.class, new Request("message"));
        Assertions.assertNotNull(response.getBody());
    ...
    void shouldReturnResponseEntityPageWhenRequestResponseEntityPageHandlerIsDispatched() {
        final var response = mediator.handle(RequestResponseEntityPageHandlerImpl.class, new Request("message"));
        Assertions.assertNotNull(response.getBody());
