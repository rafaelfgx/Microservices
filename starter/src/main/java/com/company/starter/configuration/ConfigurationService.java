...
public class ConfigurationService {
    ...
    void setConfigurations(final List<Configuration> configurations) {
        ...
        this.configurations.set(configurations.stream().collect(Collectors.toUnmodifiableMap(configuration -> configuration.id().toLowerCase(), Function.identity(), (_, last) -> last)));
    }
}
