...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http, final ObjectProvider<Customizer<AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry>> customizerProvider) {
        return http
            ...
            .oauth2ResourceServer(oauth -> oauth.jwt(jwt -> jwt.jwtAuthenticationConverter(oAuth2JwtAuthenticationConverter())))
            .build();
    }
    ...
    @Bean
    public OAuth2RestClientHttpServiceGroupConfigurer oAuth2GroupConfigurer(final OAuth2AuthorizedClientManager manager) {
