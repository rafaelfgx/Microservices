...
class CustomerMapperTest {
    ...
    void shouldReturnNullWhenCreateCustomerRequestToUserRequestIsNull() {
        Assertions.assertThat(mapper.toSaveUserRequest(null)).isNull();
    }

    @Test
    void shouldMapToUserRequestWhenCreateCustomerRequestIsValid() {
        final var saveUserRequest = mapper.toSaveUserRequest(Data.CREATE_CUSTOMER_REQUEST);
        Assertions.assertThat(saveUserRequest).isNotNull();
        Assertions.assertThat(saveUserRequest.name()).isEqualTo(Data.NAME);
        Assertions.assertThat(saveUserRequest.email()).isEqualTo(Data.EMAIL);
        Assertions.assertThat(saveUserRequest.username()).isEqualTo(Data.USERNAME);
        Assertions.assertThat(saveUserRequest.password()).isEqualTo(Data.PASSWORD);
    }
}
